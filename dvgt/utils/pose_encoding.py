...
def encode_pose(
    extrinsics, intrinsics=None, image_size_hw=None, pose_encoding_type="absT_quaR_FoV"
):
    ...
    if pose_encoding_type == "absT_quaR_FoV":
        ...
        R = extrinsics[..., :3, :3]  # BxTx3x3
        T = extrinsics[..., :3, 3]  # BxTx3
...
def decode_pose(
    pose_encoding, image_size_hw=None, pose_encoding_type="absT_quaR", build_intrinsics=False  # e.g., (256, 512)
    ...
    extrinsics_homo = to_homogeneous(extrinsics)
