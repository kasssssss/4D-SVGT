...
class PointInCamFirstLoss(nn.Module):
    ...
    def forward(self, predictions, batch):
        ...
        batch:
            points_in_cam_first: [B, T, V, H, W, 3]
        ...
        point_loss_dict = compute_point_loss(
            ...
            gt_points=batch['points_in_cam_first'],
        ...
        total_loss = point_loss_dict["loss_cam_first_conf_point"] + point_loss_dict["loss_cam_first_reg_point"] + point_loss_dict["loss_cam_first_grad_point"]
