...
class PointInEgoNLoss(nn.Module):
    ...
    def forward(self, predictions, batch):
        ...
        point_loss_dict = compute_point_loss(
            ...
            gt_points=batch['points_in_ego_n'],
        ...
        total_loss = point_loss_dict["loss_ego_n_conf_point"] + point_loss_dict["loss_ego_n_reg_point"] + point_loss_dict["loss_ego_n_grad_point"]
