...
@click.option('--pretrained', 'pretrained_model_name_or_path', default="/high_perf_store3/data-lm/xiezixun/public_checkpoints/moge-2-vitl/model.pt", help='The name or path of the pre-trained model.')
@click.option('--version', 'model_version', default='v2', help='The version of the model.')
@click.option('--fp16', 'use_fp16', default=False, help='Whether to use fp16 inference.')
